...
const availableModels = [
  { id: 'gpt-4.1', name: 'GPT-4.1', provider: 'Azure OpenAI', providerKey: 'openai', description: 'Primary flagship model (deployed)', color: '#F97316' },
  { id: 'o4-mini', name: 'O4 Mini', provider: 'Azure OpenAI', providerKey: 'openai', description: 'Fast reasoning model (deployed)', color: '#A855F7' },
  { id: 'grok-4-fast-reasoning', name: 'Grok-4 Fast Reasoning', provider: 'Azure OpenAI', providerKey: 'openai', description: 'Fast reasoning with Grok architecture (deployed)', color: '#06B6D4' },
